    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(
                ...
                'Hosseinzade_Amirhossein1400@example.com',  # Replace with your "from" email address
                [user_email],
                fail_silently=False,
            )
...
def booking(request):
    ...
    # doctors = {
    #     "Doctor care": ["Dr. Amir Hosseini"],
    #     "Nursing care": ["Nurse Fatemeh Karimi"],
    #     "Medical social services": ["Dr. Amir Hosseini"],
    #     "Home maker or basic assistance care": ["Nurse Fatemeh Karimi"],
    #     "Physical therapy": ["Dr. Sara Ahmadi"],
    #     "Speech therapy": ["Dr. Sara Ahmadi"]
    # }
...
def bookingSubmit(request):
    user = request.user
    times = [
        "3 PM", "3:30 PM", "4 PM", "4:30 PM", "5 PM", "5:30 PM", "6 PM", "6:30 PM", "7 PM", "7:30 PM", "8 PM", "8:30 PM"
    ]
    today = datetime.now()
